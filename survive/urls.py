...
urlpatterns = [
    ...
    path(
        ...
        views.survivor_season_associate,
        name="survivor_season_associate",
    ),
    # account/auth paths
    path(
        "accounts/login/",
        auth_views.LoginView.as_view(
            template_name="survive/login.html", redirect_authenticated_user=True
        ),
        name="login",
    ),
    path(
    ...
    path(
        ...
        auth_views.PasswordChangeView.as_view(
            template_name="survive/password_change.html"
        ),
    ...
    path(
        ...
        auth_views.PasswordChangeDoneView.as_view(
            template_name="survive/password_change_done.html"
        ),
    ...
    path(
        ...
        auth_views.PasswordResetView.as_view(
            template_name="survive/password_reset.html",
    ...
    path(
        ...
        auth_views.PasswordResetConfirmView.as_view(
            template_name="survive/password_reset_confirm.html"
        ),
    ...
    path(
        ...
        auth_views.PasswordResetDoneView.as_view(
            template_name="survive/password_reset_sent.html"
        ),
    ...
    path(
        ...
        auth_views.PasswordResetCompleteView.as_view(
            template_name="survive/password_reset_complete.html"
        ),
